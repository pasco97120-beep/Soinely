    ...
    <section className="relative z-10 mx-auto -mt-20 max-w-4xl px-6 sm:-mt-24">
      <div className="rounded-2xl border border-border bg-card p-6 shadow-xl sm:p-8">
        ...
        <form action="/recherche" method="GET" className="mt-5 flex flex-col gap-3 sm:flex-row">
          <input
            name="q"
            className="flex-1 rounded-xl border border-border bg-transparent px-4 py-3 text-sm outline-none focus:border-primary-500"
            placeholder="Exemple : glycémie, sonde urinaire bouchée, pansement..."
          />
          <button
            type="submit"
            className="flex items-center justify-center gap-2 rounded-xl bg-primary-500 px-5 py-3 text-sm font-medium text-white hover:bg-primary-600"
          >
